    ...
    return (
        <ul className={`nav `}>
            <li className={`nav-item nav-dropdown ${clsx({ open: activeTab === '1' })}`}>
              ...
              {user?.isAdmin &&  <ul className="nav-dropdown-items">
                ...
                <ul className="nav-dropdown-items">
                    ...
                    <li className="nav-item">
                        <a
                            onClick={() => {
                                chnageActiveTab('2');
                                router.push('/fundingIntro');
                            }}
                            className={`nav-link ${clsx({
                                'active-sub-menu': router.pathname === '/fundingIntro'
                            })}`}>
                            Funding
                        </a>
                    </li>
            ...
            {user?._id && (
                <div>
                    ...
                    <li
                        ...
                        <Link href="/history">
                            <a className="nav-link nav-dropdown-toggle">
                                <i className="fas fa-history fa-icon"></i>History
                            </a>
                        </Link>
                    </li>
                    <li
                        ...
                        <Link href="/playlist">
                            <a className="nav-link nav-dropdown-toggle">
                                <i className="fas fa-list fa-icon"></i>Playlists
                            </a>
                        </Link>
                    </li>
                </div>
