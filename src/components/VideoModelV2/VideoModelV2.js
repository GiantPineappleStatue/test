...
import { DislikeIcon, LikeIcon, PlayButton, Star, StarOutline } from '../../../public/svg';
import BotButton from '../UI/BotButton/BotButton';
import TredingVideos from '../TrendingVideosV2/TrendingVideosV2';
...
const VideoModalV2 = ({ video, show, handleClose, onHide }) => {
        ...
        <>
            <Modal size="xl" className="ModalWrapper" show={show} onHide={handleClose} centered>
                ...
                <Modal.Body className="pt-0">
                    ...
                    <div className="video-model-content">
                        ...
                        <div className="subscription-section">
                            <div className="d-flex mb-2">
                                ...
                                <div>
                                    <h3 className="sub-heading">{video.user.username}</h3>
                    ...
                    <div>
                        <TredingVideos data={video.relatedVideos} heading="Trending Videos" />
                    </div>
                    <div>
